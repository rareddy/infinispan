...
CREATE FOREIGN TABLE PhoneNumber (
	...
	Person_phone integer OPTIONS (SELECTABLE FALSE, UPDATABLE FALSE, "teiid_odata:PSEUDO" 'phone'),
	CONSTRAINT AP_PERSON_PHONE ACCESSPATTERN(Person_phone),
	CONSTRAINT FK_PERSON FOREIGN KEY(Person_phone) REFERENCES Person (id)
) OPTIONS (ANNOTATION '@Indexed', UPDATABLE TRUE, "teiid_odata:MERGE" 'Person', "teiid_odata:MESSAGE" 'quickstart.Person.PhoneNumber');